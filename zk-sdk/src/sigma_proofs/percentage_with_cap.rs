...
impl PercentageWithCapProof {
    ...
    fn create_proof_percentage_above_max(
        ...
        let z_delta = Scalar::random(&mut rand::rngs::OsRng);
        let z_claimed = Scalar::random(&mut rand::rngs::OsRng);
        let mut c_equality = Scalar::random(&mut rand::rngs::OsRng);
        ...
        let mut y_max_proof = Scalar::random(&mut rand::rngs::OsRng); // blinding factor for the percentage opening
    ...
    fn create_proof_percentage_below_max(
        ...
        let z_max_proof = Scalar::random(&mut rand::rngs::OsRng);
        let c_max_proof = Scalar::random(&mut rand::rngs::OsRng); // random challenge
        ...
        let mut y_x = Scalar::random(&mut rand::rngs::OsRng); // generate blinding factors
        let mut y_delta = Scalar::random(&mut rand::rngs::OsRng);
        let mut y_claimed = Scalar::random(&mut rand::rngs::OsRng);
